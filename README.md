# Centralized-based-control-model-for-ENCE-672
```python
...
try:
    ...
    N_P1 = 6 # The number of vehicles entering path P1 within the time horizon
    N_P2 = 6 # The number of vehicles entering path P2 within the time horizon
    N_P3 = 6 # The number of vehicles entering path P3 within the time horizon
    N_P4 = 6 # The number of vehicles entering path P4 within the time horizon
    N_P5 = 6 # The number of vehicles entering path P5 within the time horizon
    N_P6 = 6 # The number of vehicles entering path P6 within the time horizon
    N_P7 = 6 # The number of vehicles entering path P7 within the time horizon
    N_P8 = 6 # The number of vehicles entering path P8 within the time horizon
    TH = 90 # The length of the time horizon
    ...
    m.setObjective(quicksum(dt_1[i] for i in range(N_P1)) + quicksum(dt_2[i]  for i in range(N_P2)) + quicksum(dt_3[i]  for i in range(N_P3))
                + quicksum(dt_4[i]  for i in range(N_P4)) + quicksum(dt_5[i]  for i in range(N_P5)) + quicksum(dt_6[i]  for i in range(N_P6)) + quicksum(dt_7[i]  for i in range(N_P7)) + quicksum(dt_8[i]  for i in range(N_P8))
                   - sum(et_1 + et_2 + et_3 + et_4 + et_5 + et_6 + et_7 + et_8), sense=gurobipy.GRB.MINIMIZE)
